...
async function testMentorAssignmentEndorsed() {
  try {
    console.log('🧪 Testing Mentor Assignment with Endorsed Idea...\n');
    ...
    const ideaData = {
      title: 'AI-Powered Learning Assistant v3',
    ...
    if (mentors.length > 0) {
      ...
      // 9. Test sending a message as admin
      console.log('\n9. Testing mentor chat message from admin...');
      ...
      // 10. Test student accessing their assignments
      console.log('\n10. Testing student accessing mentor assignments...');
      ...
      // 11. Test student accessing their chats
      console.log('\n11. Testing student accessing mentor chats...');
