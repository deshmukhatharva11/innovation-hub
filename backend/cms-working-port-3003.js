...
const app = express();
const PORT = 3003; // Using port 3003 to avoid conflicts
...
app.get('/health', (req, res) => {
  res.json({
    status: 'OK',
    message: 'CMS Working Server is running on port 3003',
...
app.listen(PORT, () => {
  console.log('🚀 CMS Working Server running on port', PORT);
